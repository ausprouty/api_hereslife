<?php
use App\Controllers\Data\BlogMigrationController;
...
$migrationService = new BlogMigrationController($legacyDbService, $newDbService);
...
do {
    // Migrate a batch of newsletter records
    $result = $migrationService->migrateNewsletters($batchSize, $offset);
